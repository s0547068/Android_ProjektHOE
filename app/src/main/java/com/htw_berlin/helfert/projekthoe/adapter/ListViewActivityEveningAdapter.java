 ...
 */
public class ListViewActivityEveningAdapter extends BaseAdapter
{
 /*
    ...
    * der Ihm uebertragen wird. Der Context ist die ListViewActivity
    ...
    private List<Menue> eveningListe;
    ...
    public ListViewActivityEveningAdapter(Context context, DbHelper dbHelper)
    {
        this.dbHelper = dbHelper;
        eveningListe = dbHelper.getEVENING_MENUES();
        this.layoutInflater = LayoutInflater.from(context);
        this.context = context;
    }

    /**
     * Gibt die ListenGroesse zurueck
     *
     * @return: int : Listengroesse
     */
    @Override
    public int getCount()
    {
        return eveningListe.size();
    }
    ...
    {
        return this.eveningListe.get(location);
    }
    /**
    ...
    {
        return this.eveningListe.get(index).getMenueID();
    }
        ...
        * Die View repraesentiert ein einzelnes Item der ListView
        ...
        if ( currentView == null)
        {
            ...
            * den Parameter attachToRoot als False, da nicht benoetigt.
            ...
            currentView = layoutInflater.inflate(R.layout.fragment_evening, parent, false);
