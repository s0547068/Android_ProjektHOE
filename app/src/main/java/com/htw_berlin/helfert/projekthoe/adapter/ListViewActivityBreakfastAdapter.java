 ...
 */
public class ListViewActivityBreakfastAdapter extends BaseAdapter
{
    /*
    ...
    * der Ihm uebertragen wird. Der Context ist die ListViewActivity
    ...
    private List<Menue> breakfastListe;
    ...
    public ListViewActivityBreakfastAdapter(Context context, DbHelper dbHelper)
    {
        this.dbHelper = dbHelper;
        breakfastListe = dbHelper.getBREAKFAST_MENUES();
    ...
    {
        return this.breakfastListe.get(location);
    }
    /**
    ...
    {
        return this.breakfastListe.get(index).getMenueID();
    }
